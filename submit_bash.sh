...
python3 eval_operator_2d.py --config_path configs/pretrain/Customized-Re500-HFS-1s-100.yaml --test_ratio 0.25

python3 eval_operator_2d.py --config_path configs/pretrain/Customized-Re500-FNO2d-1s-100.yaml --test_ratio 0.25
